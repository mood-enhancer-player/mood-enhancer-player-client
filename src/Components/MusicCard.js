  ...
  return (
      ...
      >
        <Box className={classes.box}>
          ...
          <CardContent className={classes.cardContent}>
            <Typography className={classes.songName} align="left">{musicData.name}</Typography>
            <Typography className={classes.albumName} align="left">{musicData.name}</Typography>
    ...
    bottom: "0"}}>
        <div className="connections">
          <div className="connection facebook"></div>
        </div>
        <div style={{
          position: "absolute",
          height: "100%",
